...
= project AGENTS/workflow/handoff authoring templates
```
...
= concept-first Skill design → Markdown → implementation → design-probing tests
...
- Skill behavior changes follow concept/design → Skill Markdown → code → design-probing tests.
